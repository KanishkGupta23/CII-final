...
//         <SidebarLink icon={<FaHome />} to='/student/profile' label="Profile" isOpen={isOpen} />
//         <SidebarLink icon={<FaBook />} to='/student/editprofile' label="Edit Profile" isOpen={isOpen} />
//         <SidebarLink icon={<FaUser />} to='/student/viewapplications' label="Applications" isOpen={isOpen} />
//         <SidebarLink icon={<FaCog />} to='/student/viewjobs' label="View Jobs" isOpen={isOpen} />
//         <SidebarLink icon={<FaCog />} to='/student/resetpassword' label="Forgot Password" isOpen={isOpen} />
//       </div>
